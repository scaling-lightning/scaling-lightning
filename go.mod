...
require (
	...
	github.com/lightninglabs/lndclient v0.21.0-1 // Do not update to v1.0 even if that is what go suggests. Keep it tracking LND version.
...
// Copied from lnd to be able to run LND cli tests
